<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="http://static.squarespace.com/static/4f388e43cb12feb964d94e9f/t/518eb032e4b062fea31134d8/1368305715301/facebook.png" height="30" width="30"></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left" role="search">
        <div class="form-group">
          <input type="text" class="search" data-provide="typeahead"  data-source='[{$friends}]' placeholder="search">
        </div>
        <button type="submit" class="btn btn-default">Submit</button>
      </form>
      <ul class="nav navbar-nav navbar-right">
          <li><a href="#"></span> {Auth::user()->nombre}</a></li>
